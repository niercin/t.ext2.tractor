...
def extract_page_content(page, page_obj, page_tables, page_no, out_dir):
    ...
    for i, component in enumerate(page_elements):
        ...
        # Check the elements for images
            ...
            tmp_pdf_file_path = out_dir / 'temp_pdf.pdf'
            tmp_img_file_path = out_dir / 'temp_img.png'
            # Crop the image from the PDF
            pdfcontent.crop_image_and_saveas_pdf(element, page_obj, tmp_pdf_file_path)
...
def process_pdf_file(pdf_path, output_directory=''):
    ...
    for page_no, page in enumerate(extract_pages(pdf_path)):
        ...
        # Extract content
        content = extract_page_content(page, page_obj, page_tables, page_no, out_dir)
